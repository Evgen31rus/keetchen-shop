...
export default function Header(){
    ...
    return(
        ...
        >
        <div className={`nav fixed top-menu-shadow  z-10 flex justify-center w-[100%]  bg-white bg-opacity-75 z-30
        sm:static `}>
            <Nav/>
            <NavMobile/>
        </div>
        <div className={` banerZone header-banner relative flex w-[100%] max-w-[1000px] h-[500px] bg-no-repeat bg-cover bg-center 
        sm:w-[100%] ` }>
            <BannerZone/>
         </div>
             <SaleZone/>
