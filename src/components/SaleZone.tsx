export default function SaleZone() {
  return (
    <>
      <div
        className={`hidden flex flex-col items-center w-[100%] h-[200px] p-5 rounded bg-white   justify-center sm:flex`}
      >
        ...
        <div className={`flex flex-col`}>
          ...
          />
          <button
            className={`icon relative bg-[#E3010F] w-[150px] h-[30px] text-white`}
          >
            Получить скидку
          </button>
        </div>
